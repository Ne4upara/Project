...
private String file;
    ...
    public void gameOverFrame (GameFrame gameFrame, String over){
        ...
        switch (over){
            case "lose" -> {setFile("src\\main\\resources\\GameOver.png");
            setFinish(UTF_8("Ви проигралы со счетом 10"));}
            case "vin" -> {setFile("src\\main\\resources\\vin.jpg");
            setFinish(UTF_8("Моі Поздравления, ви Виграли"));}
            default -> {
            }
        }
